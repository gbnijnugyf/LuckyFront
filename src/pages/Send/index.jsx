...
function WishInput(props) {
    ...
    return (
        <div className="sendbc">
            ...
            <ButtonS onClick={props.goSelectTag} style={{
                background: "white",
            ...
            <ButtonS onClick={handleInput} style={{ background: "white", color: "#f25125", margin: "0.5em 0" }}>
...
export default function Send(props) {
    ...
    return (
        <div className='send'>
            <div className="mask" style={{ display: isCover ? 'flex' : 'none' }} >
                <div className="tags" style={{ display: isTagShow ? 'flex' : 'none' }}>{
                    tags.map((tag) => {
                        return (
            ...
            <WishInput handleIsAlert={handleIsAlert} content={content} goSelectTag={goSelectTag} tagName={tagName} />
        </div>
    )
}
